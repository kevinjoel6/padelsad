...
export const Privacidad = () => {
  return ( 
    <section className='privacy'>
        <Text h3>Política de la privacidad</Text>
        <div>
        <Text h5>1. INFORMACIÓN AL USUARIO</Text>
        FPIB, como Responsable del Tratamiento, le informa que, según lo dispuesto en el Reglamento (UE) 2016/679, de 27 de abril, (RGPD) y en la L.O. 3/2018, de 5 de diciembre, de protección de datos y garantía de los derechos digitales (LOPDGDD), trataremos su datos tal y como reflejamos en la presente Política de Privacidad.
        ...
        <br/>
        <Spacer></Spacer>
        <Text h5>2. CONTACTO</Text>
        Denominación social: FPIB <br/>
        Nombre comercial: FPIB <br/>
        CIF: 12345678N <br/>
        Domicilio: Carrer de Salvador Dalí, 3, 07011 Palma, Illes Balears <br/>
        Email: federacionpadel@fpib.com <br/>
        <Spacer></Spacer>
        <Text h5>3. PRINCIPIOS CLAVE</Text>
        ...
        <Spacer></Spacer>
        <Text h5>4. RECOGIDA Y TRATAMIENTO DE SUS DATOS PERSONALES</Text>
        ...
        Por se necesaria la prestación de alguno de nuestros servicios mediante relación contractual entre usted y nosotros.
        <Spacer></Spacer>
        <Text h5>6. COMUNICACIÓN DE DATOS PERSONALES</Text>
        Los datos pueden ser comunicados a empresas relacionadas con FPIB para la prestación de los diversos servicios en calidad de Encargados del Tratamiento. La empresa no realizará ninguna cesión, salvo por obligación legal.
        <Spacer></Spacer>
        <Text h5>7. SUS DERECHOS</Text>
        ...
        Puede ejercer estos derechos enviando comunicación, motivada y acreditada, a federacionpadel@fpib.com 
        ...
        <Spacer></Spacer>
        <Text h5>8. INFORMACIÓN LEGAL</Text>
